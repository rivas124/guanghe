...
export function TabPanel(props) {
    ...
    return (
        ...
        >
            {value === index && (
                <Box sx={{ p: 3 }}>
                    <Typography align='left' color='#888'>{children}</Typography>
                </Box>
            )}
        </div>
    );
          ...
          {c==0 ?
            <Box className={styles.form}>
                ...
                <TabPanel value={value} index={0} sx={{width:"100%"}}>
                    <Typography align='left' color='#888'> 用户名:</Typography>
                    <AppTextField
                        placeholder="请输入用户名..."
                        onChange={(event) => {
                    ...
                    <Typography align='left' color='#888'>密码:</Typography>
                    <AppTextField
                        placeholder="请输入密码..."
                    ...
                    <AppButtonGroup type="primary" sx={{margin:'1rem 20%',width:'50%'}}>
                        <AppButton
                ...
                <TabPanel value={value} index={1}>
                    ...
                    <br />
                    <Typography align='left' color='#888'>确认密码:</Typography>
                    <AppTextField
                        placeholder="请再次输入密码..."
                    ...
                    />
                    <br />
                    <Typography align='left' color='#888'>电话:</Typography>
                    <AppTextField
                        placeholder="请输入电话..."
